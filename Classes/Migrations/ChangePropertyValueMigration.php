 ...
 * but with the added ability to search and replace in numeric values.
 * This is useful when you want to change a property value that is a number but you want to change it to a string.
 */
...
class ChangePropertyValueMigration extends AbstractTransformation
{
    ...
    public function execute(NodeData $node)
    {
        ...
        if (is_numeric($currentPropertyValue) && is_string($this->newValue)) {
